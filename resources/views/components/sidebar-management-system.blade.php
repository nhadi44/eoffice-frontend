       ...
       <div class="sidebar-wrapper active">
           <div class="sidebar-header position-relative">
               <div class="d-flex justify-content-between align-items-center">
                   <div class="logo">
                       <a href="index.html" class="app-text-name">
                           E Office
                       </a>
                   </div>
                   {{-- Switch button theme --}}
           ...
           <div class="sidebar-menu">
               <ul class="menu">
                   <li class="sidebar-item {{ request()->is('eoffice/managements/system') ? 'active' : '' }} ">
                       <a href="{{ route('eoffice.managements.system') }}" class='sidebar-link'>
                   ...
                   <li
                       ...
                       <ul
                           ...
                           <li
                               class="submenu-item {{ request()->is('eoffice/managements/system/master-data/employees') ? 'active' : '' }}">
                               <a href="{{ route('eoffice.managements.system.master-data.employees') }}"
